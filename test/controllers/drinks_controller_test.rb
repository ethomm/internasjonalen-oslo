...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { category_id: @drink.category_id, description: @drink.description, price: @drink.price, slug: @drink.slug, title: @drink.title } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { category_id: @drink.category_id, description: @drink.description, price: @drink.price, slug: @drink.slug, title: @drink.title } }
